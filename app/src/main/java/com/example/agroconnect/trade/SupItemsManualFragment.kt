...
import com.example.agroconnect.databinding.FragmentSupItemsManualBinding
import com.example.agroconnect.datamodel.ProductFashion
import com.example.agroconnect.ui.AddProductsViewModel
...
//        sessionPreferences = requireContext().getSharedPreferences("session", Context.MODE_PRIVATE)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvUser.text = "User: " + product.user?.name
